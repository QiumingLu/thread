...
class scoped_ptr {
 public:
  ...
  // not just two different but equal objects.
...
// scoped_array<C> is like scoped_ptr<C>, excepts that the caller must cllocate
...
class scoped_array {
 public:
  ...
  // Constructor. Defaults to initializing with NULL.
  // There is no way to create an unitialized scoped_array.
  // The input parameter must be allocated with new [].
